...
import com.mycompany.bidamanagement.bill.ReportManager45;
...
// Phương thức để khôi phục dữ liệu khi quay lại trang ban đầu
    ...
    private void PrintBtnTable16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrintBtnTable16ActionPerformed
        ...
        String TableFee16 = CommonFunction.calculateTimePlayTablePrice45(startHourTable16, startMinuteTable16, startSecondTable16, endHourTable16, endMinuteTable16, endSecondTable16);
        ...
        try {
            ...
            if(soLanBamAddTable16 > 0) {
                ...
                ReportManager45.getInstance().printReportPaymentTable(dataprint16);
            }
            else {
                ...
                ReportManager45.getInstance().printReportPayment(dataprint16);
            }
