...
// Phương thức để khôi phục dữ liệu khi quay lại trang ban đầu
    ...
    private void PrintBtnTable18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrintBtnTable18ActionPerformed
        ...
        String TableFee18 = CommonFunction.calculateTimePlayTablePrice45(startHourTable18, startMinuteTable18, startSecondTable18, endHourTable18, endMinuteTable18, endSecondTable18);
        ...
        try {
            ...
            if(soLanBamAddTable18 > 0) {
                ...
                ReportManager45.getInstance().printReportPaymentTable(dataprint18);
            }
            else {
                ...
                ReportManager45.getInstance().printReportPayment(dataprint18);
            }
