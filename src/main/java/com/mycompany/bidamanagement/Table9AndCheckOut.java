 ...
 * @author duc
 */
public class Table9AndCheckOut extends javax.swing.JFrame {
    ...
    // Sử dụng lớp Singleton để lưu trữ biến inputData Table 9
    ...
    public Table9AndCheckOut() {
        ...
        if ("".equals(NameTable9.getText())) {
            NameTable9.setText("BÀN 9");
        }
        SelectBill();
        getCategory();
        updateTotalBill();
    ...
    private void restoreDataTable9() {
        TIMESTART9.setText(dataHolderTable9.getInputDataSTARTTable9());
        TIMEEND9.setText(dataHolderTable9.getInputDataENDTable9());
        NameTable9.setText(dataHolderTable9.getInputDataNameTable9());
        Name9.setText(dataHolderTable9.getInputDataName9());
        // Khôi phục màu sắc của NameTable từ DataHolder
        String colorAsString1 = dataHolderTable9.getInputColorDataNameTable9();
        String colorAsString2 = dataHolderTable9.getInputColorDataName9();
        String[] colorComponents9 = colorAsString1.split(",");
        if (colorComponents9.length == 3) {
            int red = Integer.parseInt(colorComponents9[0]);
            int green = Integer.parseInt(colorComponents9[1]);
            int blue = Integer.parseInt(colorComponents9[2]);
            Color color1 = new Color(red, green, blue);
            NameTable9.setForeground(color1);
            Name9.setForeground(color1);
        }
        StartBtnTable9.setEnabled(dataHolderTable9.isStartBtnEnabledTable9());
        StopBtnTable9.setEnabled(dataHolderTable9.isStopBtnEnabledTable9());
        PrintBtnTable9.setEnabled(dataHolderTable9.isPrintBtnEnabledTable9());
        startHourTable9 = dataHolderTable9.getStartHourTable9();
        startMinuteTable9 = dataHolderTable9.getStartMinuteTable9();
        startSecondTable9 = dataHolderTable9.getStartSecondTable9();
        endHourTable9 = dataHolderTable9.getEndHourTable9();
        endMinuteTable9 = dataHolderTable9.getEndMinuteTable9();
        endSecondTable9 = dataHolderTable9.getEndSecondTable9();
        AddBtnTable9.setEnabled(dataHolderTable9.isAddBtnEnabledTable9());
    }

    
    private void saveInputDataTable9() {
        dataHolderTable9.setInputDataSTARTTable9(TIMESTART9.getText());
        dataHolderTable9.setInputDataENDTable9(TIMEEND9.getText());
        dataHolderTable9.setInputDataNameTable9(NameTable9.getText());
        dataHolderTable9.setInputDataName9(Name9.getText());

        // Chuyển đổi màu sắc của Table9Name thành mã màu RGB và lưu vào DataHolder
        Color color = NameTable9.getForeground();
        Color color2 = Name9.getForeground();
        String colorAsString = String.format("%d,%d,%d", color.getRed(), color.getGreen(), color.getBlue());
        dataHolderTable9.setInputColorDataNameTable9(colorAsString);
        String colorAsString2 = String.format("%d,%d,%d", color2.getRed(), color2.getGreen(), color2.getBlue());
        dataHolderTable9.setInputColorDataName9(colorAsString2);
        dataHolderTable9.setStartBtnEnabledTable9(StartBtnTable9.isEnabled());
        dataHolderTable9.setStopBtnEnabledTable9(StopBtnTable9.isEnabled());
        dataHolderTable9.setPrintBtnEnabledTable9(PrintBtnTable9.isEnabled());

        dataHolderTable9.setStartHourTable9(startHourTable9);
        dataHolderTable9.setStartMinuteTable9(startMinuteTable9);
        dataHolderTable9.setStartSecondTable9(startSecondTable9);
        dataHolderTable9.setEndHourTable9(endHourTable9);
        dataHolderTable9.setEndMinuteTable9(endMinuteTable9);
        dataHolderTable9.setEndSecondTable9(endSecondTable9);

        dataHolderTable9.setAddBtnEnabledTable9(AddBtnTable9.isEnabled());
    }
    
    private void restoreInputDataTable10() {
        Name18.setText(dataHolderTable10.getInputDataName10());
        // Khôi phục màu sắc của NameTable từ DataHolder
        ...
        if (colorComponents10.length == 3) {
            ...
            Color color10 = new Color(red, green, blue);
            Name18.setForeground(color10);
        }
    }

    private BillTable9 billTable9 = BillTable9.getInstanceTable9();
    private boolean checkTrueBillDetailTable9 = false;
    ...
    private void saveBillTable9() {
        billTable9.setBillReviewTable9(BillReview.getText());
        billTable9.setIsBillIdDetailTable9(checkTrueBillDetailTable9);
        billTable9.setInvoiceIdTable9(invoiceIdTable9);
        billTable9.setSoLanBamAddTable9(soLanBamAddTable9);
        billTable9.setSaveBillPriceTable9(saveBillPriceTable9);
    }

    // Phương thức để khôi phục dữ liệu khi quay lại trang ban đầu
    private void restoreBillTable9() {
        BillReview.setText(billTable9.getBillReviewTable9());
        checkTrueBillDetailTable9 = billTable9.isBillIdDetailTable9();
        invoiceIdTable9 = billTable9.getInvoiceIdTable9();
        soLanBamAddTable9 = billTable9.getSoLanBamAddTable9();
        TotalBill = billTable9.getSaveBillPriceTable9();
        TotalBillRender.setText("TỔNG CỘNG: " + CommonFunction.doubleFormattedView(billTable9.getSaveBillPriceTable9()));
    }
    ...
    private void initComponents() {
        ...
        AddBtnTable9 = new javax.swing.JButton();
        ClearBtn = new javax.swing.JButton();
        table1 = new javax.swing.JPanel();
        jPanel13 = new javax.swing.JPanel();
        NameTable9 = new javax.swing.JLabel();
        jPanel14 = new javax.swing.JPanel();
        jPanel17 = new javax.swing.JPanel();
        jLabel4 = new javax.swing.JLabel();
        SDTKH9 = new javax.swing.JTextField();
        jPanel15 = new javax.swing.JPanel();
        jPanel19 = new javax.swing.JPanel();
        jLabel7 = new javax.swing.JLabel();
        TIMESTART9 = new javax.swing.JTextField();
        jPanel67 = new javax.swing.JPanel();
        jLabel34 = new javax.swing.JLabel();
        TIMEEND9 = new javax.swing.JTextField();
        jPanel16 = new javax.swing.JPanel();
        StartBtnTable9 = new javax.swing.JButton();
        StopBtnTable9 = new javax.swing.JButton();
        PrintBtnTable9 = new javax.swing.JButton();
        ResetBtnTable9 = new javax.swing.JButton();
        ...
        AddBtnTable9.setBackground(new java.awt.Color(110, 178, 246));
        AddBtnTable9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        AddBtnTable9.setForeground(new java.awt.Color(255, 255, 255));
        AddBtnTable9.setText("THÊM");
        AddBtnTable9.setBorder(null);
        AddBtnTable9.setBorderPainted(false);
        AddBtnTable9.setEnabled(false);
        AddBtnTable9.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                AddBtnTable9MouseClicked(evt);
            }
        });
        AddBtnTable9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AddBtnTable9ActionPerformed(evt);
            }
        });
        ...
        NameTable9.setBackground(new java.awt.Color(249, 249, 249));
        NameTable9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        NameTable9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        NameTable9.setText("BÀN 9");
        NameTable9.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                NameTable9MouseClicked(evt);
            }
        });
        ...
        jPanel13Layout.setHorizontalGroup(
            ...
            .addComponent(NameTable9, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        jPanel13Layout.setVerticalGroup(
            jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(NameTable9, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );
        ...
        SDTKH9.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addComponent(SDTKH9, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        TIMESTART9.setBackground(new java.awt.Color(248, 248, 248));
        TIMESTART9.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        TIMESTART9.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TIMESTART9.setDisabledTextColor(new java.awt.Color(51, 51, 51));
        TIMESTART9.setEnabled(false);
        TIMESTART9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TIMESTART9ActionPerformed(evt);
            }
        });
        ...
        jPanel19Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(TIMESTART9, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        TIMEEND9.setBackground(new java.awt.Color(248, 248, 248));
        TIMEEND9.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        TIMEEND9.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TIMEEND9.setDisabledTextColor(new java.awt.Color(51, 51, 51));
        TIMEEND9.setEnabled(false);
        TIMEEND9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TIMEEND9ActionPerformed(evt);
            }
        });
        ...
        jPanel67Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel67Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(TIMEEND9, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        StartBtnTable9.setBackground(new java.awt.Color(237, 237, 237));
        StartBtnTable9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        StartBtnTable9.setText("BẮT ĐẦU");
        StartBtnTable9.setBorder(null);
        StartBtnTable9.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                StartBtnTable9MouseClicked(evt);
            }
        });
        StartBtnTable9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                StartBtnTable9ActionPerformed(evt);
            }
        });

        StopBtnTable9.setBackground(new java.awt.Color(237, 237, 237));
        StopBtnTable9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        StopBtnTable9.setText("DỪNG LẠI");
        StopBtnTable9.setBorder(null);
        StopBtnTable9.setEnabled(false);
        StopBtnTable9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                StopBtnTable9ActionPerformed(evt);
            }
        });

        PrintBtnTable9.setBackground(new java.awt.Color(110, 178, 246));
        PrintBtnTable9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        PrintBtnTable9.setForeground(new java.awt.Color(255, 255, 255));
        PrintBtnTable9.setText("IN HÓA ĐƠN");
        PrintBtnTable9.setBorder(null);
        PrintBtnTable9.setEnabled(false);
        PrintBtnTable9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PrintBtnTable9ActionPerformed(evt);
            }
        });

        ResetBtnTable9.setBackground(new java.awt.Color(255, 51, 51));
        ResetBtnTable9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ResetBtnTable9.setForeground(new java.awt.Color(255, 255, 255));
        ResetBtnTable9.setText("RESET");
        ResetBtnTable9.setBorder(null);
        ResetBtnTable9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ResetBtnTable9ActionPerformed(evt);
            }
        });
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(StartBtnTable9, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                    .addComponent(ResetBtnTable9, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(StopBtnTable9, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(PrintBtnTable9, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE))
                .addGap(18, 18, 18))
        );
        jPanel16Layout.setVerticalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(StartBtnTable9, javax.swing.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
                    .addComponent(StopBtnTable9, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(ResetBtnTable9, javax.swing.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
                    .addComponent(PrintBtnTable9, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(AddBtnTable9, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(AddBtnTable9, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        PlayTable9Btn.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void AddBtnTable9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddBtnTable9MouseClicked
        if (AddBtnTable9.isEnabled()) {
            ...
            if(PRODQTY.getText().isEmpty() || PRODNAME.getText().isEmpty() ){
                ...
                if (soLanBamAddTable9 == 1) {
                    ...
                    try {
                        ...
                        if (result.next()) {
                            ...
                            invoiceIdTable9 = currentInvoice;
                            System.out.println("currentInvoiceID: " + invoiceIdTable9);
                            ...
                            addInvoiceDetail.setInt(1, invoiceIdTable9);
                    ...
                    try {
                        ...
                        checkExistingProduct.setInt(1, invoiceIdTable9);
                        ...
                        if (existingProductResult.next()) {
                            ...
                            updateInvoiceDetail.setInt(3, invoiceIdTable9);
                ...
                checkTrueBillDetailTable9 = true;
                saveBillTable9();
            }
        }
    }//GEN-LAST:event_AddBtnTable9MouseClicked

    private void AddBtnTable9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnTable9ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_AddBtnTable9ActionPerformed
    ...
    private void NameTable9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NameTable9MouseClicked

    }//GEN-LAST:event_NameTable9MouseClicked

    private void TIMESTART9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TIMESTART9ActionPerformed

    }//GEN-LAST:event_TIMESTART9ActionPerformed

    private void TIMEEND9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TIMEEND9ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TIMEEND9ActionPerformed

    private void StartBtnTable9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_StartBtnTable9MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_StartBtnTable9MouseClicked

    private void StartBtnTable9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartBtnTable9ActionPerformed
        ...
        TIMESTART9.setText(formatStartTable1);
        NameTable9.setText("BÀN 9 (ĐANG CHƠI)");
        Name9.setText("BÀN 9 (ĐANG CHƠI)");
        NameTable9.setForeground(Color.RED);
        Name9.setForeground(Color.RED);

        StartBtnTable9.setEnabled(false);
        StopBtnTable9.setEnabled(true);

        Calendar cal = Calendar.getInstance();
        cal.setTime(currentStartTable1);

        startHourTable9 = cal.get(Calendar.HOUR_OF_DAY);
        startMinuteTable9 = cal.get(Calendar.MINUTE);
        startSecondTable9 = cal.get(Calendar.SECOND);

        AddBtnTable9.setEnabled(true);

        saveInputDataTable9();
    }//GEN-LAST:event_StartBtnTable9ActionPerformed

    private void StopBtnTable9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StopBtnTable9ActionPerformed
        ...
        TIMEEND9.setText(formatStopTable1);
        NameTable9.setText("BÀN 9 (ĐANG TÍNH TIỀN)");
        NameTable9.setForeground(Color.YELLOW);
        Name9.setText("BÀN 9 (ĐANG TÍNH TIỀN)");
        Name9.setForeground(Color.YELLOW);
        StopBtnTable9.setEnabled(false);
        PrintBtnTable9.setEnabled(true);

        Calendar cal = Calendar.getInstance();
        cal.setTime(currentStopTable1);

        endHourTable9 = cal.get(Calendar.HOUR_OF_DAY);
        endMinuteTable9 = cal.get(Calendar.MINUTE);
        endSecondTable9 = cal.get(Calendar.SECOND);

        //Luu gia tri sau khi set moi bien
        saveInputDataTable9();
    }//GEN-LAST:event_StopBtnTable9ActionPerformed

    private void PrintBtnTable9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrintBtnTable9ActionPerformed
        Date currentPrintTable9 = new Date();
        SimpleDateFormat datePrintTable9 = new SimpleDateFormat("HH:mm:ss dd/MM/yyyy");
        String formatPrintTable9 = datePrintTable9.format(currentPrintTable9);
        String TableFee9 = CommonFunction.calculateTimePlayTablePrice55(startHourTable9, startMinuteTable9, startSecondTable9, endHourTable9, endMinuteTable9, endSecondTable9);
        Double totalFeeBill = Double.parseDouble(TableFee9) + TotalBill;
        String convertTotalFeeToString = CommonFunction.doubleFormattedView(totalFeeBill);
        System.out.println("totalfee: "+TableFee9 + " savePrice: " + TotalBill +" totalBill: "+ convertTotalFeeToString);
        try {
            ...
            addTableBill.setString(1, SDTKH9.getText());
            addTableBill.setString(2, formatPrintTable9);
            addTableBill.setString(3, TIMESTART9.getText());
            addTableBill.setString(4, TIMEEND9.getText());
            addTableBill.setString(5, TableFee9);
            addTableBill.setInt(6, 9);
            addTableBill.executeUpdate();

            if(soLanBamAddTable9 > 0) {
                ParameterReportCheckoutTable dataprint9 = new ParameterReportCheckoutTable(formatPrintTable9, TIMESTART9.getText(), TIMEEND9.getText(), TableFee9, invoiceIdTable9, convertTotalFeeToString);
                ReportManager55.getInstance().printReportPaymentTable(dataprint9);
            }
            else {
                ParameterReportCheckout dataprint9 = new ParameterReportCheckout(formatPrintTable9, TIMESTART9.getText(), TIMEEND9.getText(), TableFee9);
                ReportManager55.getInstance().printReportPayment(dataprint9);
            }

            PrintBtnTable9.setEnabled(false);
            NameTable9.setText("BÀN 9");
            NameTable9.setForeground(Color.BLACK);
            Name9.setText("BÀN 9");
            Name9.setForeground(Color.BLACK);
            StartBtnTable9.setEnabled(true);
            StopBtnTable9.setEnabled(false);
            TIMESTART9.setText("");
            TIMEEND9.setText("");
            SDTKH9.setText("");
            AddBtnTable9.setEnabled(false);
            saveInputDataTable9();
            System.out.println("Start time: " + startHourTable9 + ":" + startMinuteTable9 + ":" + startSecondTable9);
            System.out.println("End time: " + endHourTable9 + ":" + endMinuteTable9 + ":" + endSecondTable9);

            // Xu ly cho ca table va bill
            checkTrueBillDetailTable9 = false;
            PRODNAME.setText("");
            PRODQTY.setText("");
            BillReview.setText("");
            soLanBamAddTable9 = 0;
    ...
    }//GEN-LAST:event_PrintBtnTable9ActionPerformed

    private void ResetBtnTable9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ResetBtnTable9ActionPerformed
    ...
    }//GEN-LAST:event_ResetBtnTable9ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Table9AndCheckOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton AddBtnTable9;
    ...
    private javax.swing.JLabel NameTable9;
    ...
    private javax.swing.JButton PrintBtnTable9;
    private javax.swing.JButton ReloadBtn;
    private javax.swing.JButton ResetBtnTable9;
    private javax.swing.JTextField SDTKH9;
    private javax.swing.JButton StartBtnTable9;
    private javax.swing.JButton StopBtnTable9;
    private javax.swing.JPanel SwapNormalBtn;
    private javax.swing.JPanel SwapVipBtn;
    private javax.swing.JTextField TIMEEND9;
    private javax.swing.JTextField TIMESTART9;
