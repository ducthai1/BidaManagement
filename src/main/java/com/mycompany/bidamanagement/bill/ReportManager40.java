...
public class ReportManager40 {
    private static ReportManager40 instance;
    private JasperReport tableBill;
    private JasperReport tableBillOnlyTable;

    public static ReportManager40 getInstance() {
        if (instance == null) {
            instance = new ReportManager40();
        }
        return instance;
    }

    private ReportManager40() {}
    
    public void compileReport() throws JRException {
        try {
            // Load the JRXML file as input stream
            String inputStream2 = "src/main/java/com/mycompany/bidamanagement/table/tableBill40.jrxml";
            String inputStream = "src/main/java/com/mycompany/bidamanagement/TableAndBill/tableAndBill40.jrxml";
            if (inputStream == null) {
