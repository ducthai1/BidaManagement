...
public class ReportManager50 {
    private static ReportManager50 instance;
    private JasperReport tableBill;
    private JasperReport tableBillOnlyTable;

    public static ReportManager50 getInstance() {
        if (instance == null) {
            instance = new ReportManager50();
        }
        return instance;
    }

    private ReportManager50() {}
    
    public void compileReport() throws JRException {
        try {
            // Load the JRXML file as input stream
            String inputStream2 = "src/main/java/com/mycompany/bidamanagement/table/tableBill50.jrxml";
            String inputStream = "src/main/java/com/mycompany/bidamanagement/TableAndBill/tableAndBill50.jrxml";
            if (inputStream == null) {
