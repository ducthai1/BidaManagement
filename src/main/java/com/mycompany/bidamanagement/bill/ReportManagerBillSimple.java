...
public class ReportManagerBillSimple {
    private static ReportManagerBillSimple instance;
    private JasperReport tableBill;
    private JasperReport tableBillOnlyTable;

    public static ReportManagerBillSimple getInstance() {
        if (instance == null) {
            instance = new ReportManagerBillSimple();
        }
        return instance;
    }

    private ReportManagerBillSimple() {}
    
    public void compileReport() throws JRException {
        try {
            // Load the JRXML file as input stream
            String inputStream2 = "src/main/java/com/mycompany/bidamanagement/table/billSimple.jrxml";
            String inputStream = "src/main/java/com/mycompany/bidamanagement/TableAndBill/billSimple.jrxml";
            if (inputStream == null) {
    ...
    Connection conn;
    public void printReportPayment(ParameterReportCheckoutTable data) throws JRException, FileNotFoundException {
        try {
            Map<String, Object> parameters = new HashMap<>();
