...
public class ReportManager55 {
    private static ReportManager55 instance;
    private JasperReport tableBill;
    private JasperReport tableBillOnlyTable;

    public static ReportManager55 getInstance() {
        if (instance == null) {
            instance = new ReportManager55();
        }
        return instance;
    }

    private ReportManager55() {}
    
    public void compileReport() throws JRException {
        try {
            // Load the JRXML file as input stream
            String inputStream2 = "src/main/java/com/mycompany/bidamanagement/table/tableBill55.jrxml";
            String inputStream = "src/main/java/com/mycompany/bidamanagement/TableAndBill/tableAndBill55.jrxml";
            if (inputStream == null) {
