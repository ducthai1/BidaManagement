...
public class CommonFunction {
    ...
    public static String calculateTimePlayTablePrice45(int startHour, int startMinute, int startSecond, int endHour, int endMinute, int endSecond) {
        final int SECONDS_IN_HOUR = 3600;
        final int SECONDS_IN_MINUTE = 60;
        final double PRICE_PER_HOUR = 45.0;
