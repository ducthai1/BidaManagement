 ...
 * @author duc
 */
public class Table11AndCheckOut extends javax.swing.JFrame {
    ...
    public Table11AndCheckOut() {
        ...
        if ("".equals(NameTable11.getText())) {
            NameTable11.setText("BÀN 11");
        }
        SelectBill();
        getCategory();
        updateTotalBill();
    ...
    private void restoreDataTable11() {
        TIMESTART11.setText(dataHolderTable11.getInputDataSTARTTable11());
        TIMEEND11.setText(dataHolderTable11.getInputDataENDTable11());
        NameTable11.setText(dataHolderTable11.getInputDataNameTable11());
        Name11.setText(dataHolderTable11.getInputDataName11());
        // Khôi phục màu sắc của NameTable từ DataHolder
        String colorAsString1 = dataHolderTable11.getInputColorDataNameTable11();
        String colorAsString2 = dataHolderTable11.getInputColorDataName11();
        String[] colorComponents11 = colorAsString1.split(",");
        if (colorComponents11.length == 3) {
            int red = Integer.parseInt(colorComponents11[0]);
            int green = Integer.parseInt(colorComponents11[1]);
            int blue = Integer.parseInt(colorComponents11[2]);
            Color color1 = new Color(red, green, blue);
            NameTable11.setForeground(color1);
            Name11.setForeground(color1);
        }
        StartBtnTable11.setEnabled(dataHolderTable11.isStartBtnEnabledTable11());
        StopBtnTable11.setEnabled(dataHolderTable11.isStopBtnEnabledTable11());
        PrintBtnTable11.setEnabled(dataHolderTable11.isPrintBtnEnabledTable11());
        startHourTable11 = dataHolderTable11.getStartHourTable11();
        startMinuteTable11 = dataHolderTable11.getStartMinuteTable11();
        startSecondTable11 = dataHolderTable11.getStartSecondTable11();
        endHourTable11 = dataHolderTable11.getEndHourTable11();
        endMinuteTable11 = dataHolderTable11.getEndMinuteTable11();
        endSecondTable11 = dataHolderTable11.getEndSecondTable11();
        AddBtnTable11.setEnabled(dataHolderTable11.isAddBtnEnabledTable11());
    }
    
    private void saveInputDataTable11() {
        dataHolderTable11.setInputDataSTARTTable11(TIMESTART11.getText());
        dataHolderTable11.setInputDataENDTable11(TIMEEND11.getText());
        dataHolderTable11.setInputDataNameTable11(NameTable11.getText());
        dataHolderTable11.setInputDataName11(Name11.getText());

        // Chuyển đổi màu sắc của Table11Name thành mã màu RGB và lưu vào DataHolder
        Color color = NameTable11.getForeground();
        Color color2 = Name11.getForeground();
        String colorAsString = String.format("%d,%d,%d", color.getRed(), color.getGreen(), color.getBlue());
        dataHolderTable11.setInputColorDataNameTable11(colorAsString);
        String colorAsString2 = String.format("%d,%d,%d", color2.getRed(), color2.getGreen(), color2.getBlue());
        dataHolderTable11.setInputColorDataName11(colorAsString2);
        dataHolderTable11.setStartBtnEnabledTable11(StartBtnTable11.isEnabled());
        dataHolderTable11.setStopBtnEnabledTable11(StopBtnTable11.isEnabled());
        dataHolderTable11.setPrintBtnEnabledTable11(PrintBtnTable11.isEnabled());

        dataHolderTable11.setStartHourTable11(startHourTable11);
        dataHolderTable11.setStartMinuteTable11(startMinuteTable11);
        dataHolderTable11.setStartSecondTable11(startSecondTable11);
        dataHolderTable11.setEndHourTable11(endHourTable11);
        dataHolderTable11.setEndMinuteTable11(endMinuteTable11);
        dataHolderTable11.setEndSecondTable11(endSecondTable11);

        dataHolderTable11.setAddBtnEnabledTable11(AddBtnTable11.isEnabled());
    }

    private BillTable11 billTable11 = BillTable11.getInstanceTable11();
    private boolean checkTrueBillDetailTable11 = false;
...
// Phương thức để lưu trữ dữ liệu khi người dùng nhập vào ô input
    private void saveBillTable11() {
        billTable11.setBillReviewTable11(BillReview.getText());
        billTable11.setIsBillIdDetailTable11(checkTrueBillDetailTable11);
        billTable11.setInvoiceIdTable11(invoiceIdTable11);
        billTable11.setSoLanBamAddTable11(soLanBamAddTable11);
        billTable11.setSaveBillPriceTable11(saveBillPriceTable11);
    }

// Phương thức để khôi phục dữ liệu khi quay lại trang ban đầu
    private void restoreBillTable11() {
        BillReview.setText(billTable11.getBillReviewTable11());
        checkTrueBillDetailTable11 = billTable11.isBillIdDetailTable11();
        invoiceIdTable11 = billTable11.getInvoiceIdTable11();
        soLanBamAddTable11 = billTable11.getSoLanBamAddTable11();
        TotalBill = billTable11.getSaveBillPriceTable11();
        TotalBillRender.setText("TỔNG CỘNG: " + CommonFunction.doubleFormattedView(billTable11.getSaveBillPriceTable11()));
    }
    ...
    private void initComponents() {
        ...
        AddBtnTable11 = new javax.swing.JButton();
        ClearBtn = new javax.swing.JButton();
        table1 = new javax.swing.JPanel();
        jPanel13 = new javax.swing.JPanel();
        NameTable11 = new javax.swing.JLabel();
        jPanel14 = new javax.swing.JPanel();
        jPanel17 = new javax.swing.JPanel();
        jLabel4 = new javax.swing.JLabel();
        SDTKH11 = new javax.swing.JTextField();
        jPanel15 = new javax.swing.JPanel();
        jPanel19 = new javax.swing.JPanel();
        jLabel7 = new javax.swing.JLabel();
        TIMESTART11 = new javax.swing.JTextField();
        jPanel67 = new javax.swing.JPanel();
        jLabel34 = new javax.swing.JLabel();
        TIMEEND11 = new javax.swing.JTextField();
        jPanel16 = new javax.swing.JPanel();
        StartBtnTable11 = new javax.swing.JButton();
        StopBtnTable11 = new javax.swing.JButton();
        PrintBtnTable11 = new javax.swing.JButton();
        ResetBtnTable11 = new javax.swing.JButton();
        ...
        AddBtnTable11.setBackground(new java.awt.Color(110, 178, 246));
        AddBtnTable11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        AddBtnTable11.setForeground(new java.awt.Color(255, 255, 255));
        AddBtnTable11.setText("THÊM");
        AddBtnTable11.setBorder(null);
        AddBtnTable11.setBorderPainted(false);
        AddBtnTable11.setEnabled(false);
        AddBtnTable11.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                AddBtnTable11MouseClicked(evt);
            }
        });
        AddBtnTable11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AddBtnTable11ActionPerformed(evt);
            }
        });
        ...
        NameTable11.setBackground(new java.awt.Color(249, 249, 249));
        NameTable11.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        NameTable11.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        NameTable11.setText("BÀN 11");
        NameTable11.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                NameTable11MouseClicked(evt);
            }
        });
        ...
        jPanel13Layout.setHorizontalGroup(
            ...
            .addComponent(NameTable11, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        jPanel13Layout.setVerticalGroup(
            jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(NameTable11, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );
        ...
        SDTKH11.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jPanel17Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel17Layout.createSequentialGroup()
                ...
                .addComponent(SDTKH11, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        TIMESTART11.setBackground(new java.awt.Color(248, 248, 248));
        TIMESTART11.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        TIMESTART11.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TIMESTART11.setDisabledTextColor(new java.awt.Color(51, 51, 51));
        TIMESTART11.setEnabled(false);
        TIMESTART11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TIMESTART11ActionPerformed(evt);
            }
        });
        ...
        jPanel19Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel19Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(TIMESTART11, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        TIMEEND11.setBackground(new java.awt.Color(248, 248, 248));
        TIMEEND11.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        TIMEEND11.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TIMEEND11.setDisabledTextColor(new java.awt.Color(51, 51, 51));
        TIMEEND11.setEnabled(false);
        TIMEEND11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TIMEEND11ActionPerformed(evt);
            }
        });
        ...
        jPanel67Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel67Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(TIMEEND11, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        StartBtnTable11.setBackground(new java.awt.Color(237, 237, 237));
        StartBtnTable11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        StartBtnTable11.setText("BẮT ĐẦU");
        StartBtnTable11.setBorder(null);
        StartBtnTable11.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                StartBtnTable11MouseClicked(evt);
            }
        });
        StartBtnTable11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                StartBtnTable11ActionPerformed(evt);
            }
        });

        StopBtnTable11.setBackground(new java.awt.Color(237, 237, 237));
        StopBtnTable11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        StopBtnTable11.setText("DỪNG LẠI");
        StopBtnTable11.setBorder(null);
        StopBtnTable11.setEnabled(false);
        StopBtnTable11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                StopBtnTable11ActionPerformed(evt);
            }
        });

        PrintBtnTable11.setBackground(new java.awt.Color(110, 178, 246));
        PrintBtnTable11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        PrintBtnTable11.setForeground(new java.awt.Color(255, 255, 255));
        PrintBtnTable11.setText("IN HÓA ĐƠN");
        PrintBtnTable11.setBorder(null);
        PrintBtnTable11.setEnabled(false);
        PrintBtnTable11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PrintBtnTable11ActionPerformed(evt);
            }
        });

        ResetBtnTable11.setBackground(new java.awt.Color(255, 51, 51));
        ResetBtnTable11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ResetBtnTable11.setForeground(new java.awt.Color(255, 255, 255));
        ResetBtnTable11.setText("RESET");
        ResetBtnTable11.setBorder(null);
        ResetBtnTable11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ResetBtnTable11ActionPerformed(evt);
            }
        });
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(StartBtnTable11, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                    .addComponent(ResetBtnTable11, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(StopBtnTable11, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(PrintBtnTable11, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE))
                .addGap(18, 18, 18))
        );
        jPanel16Layout.setVerticalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(StartBtnTable11, javax.swing.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
                    .addComponent(StopBtnTable11, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(ResetBtnTable11, javax.swing.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
                    .addComponent(PrintBtnTable11, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(AddBtnTable11, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(AddBtnTable11, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        PlayTable11Btn.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void AddBtnTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddBtnTable11MouseClicked
        if (AddBtnTable11.isEnabled()) {
            ...
            if(PRODQTY.getText().isEmpty() || PRODNAME.getText().isEmpty() ){
                ...
                saveBillPriceTable11 = TotalBill;
                ...
                if (soLanBamAddTable11 == 1) {
                    ...
                    try {
                        ...
                        if (result.next()) {
                            ...
                            invoiceIdTable11 = currentInvoice;
                            System.out.println("currentInvoiceID: " + invoiceIdTable11);
                            ...
                            addInvoiceDetail.setInt(1, invoiceIdTable11);
                    ...
                    try {
                        ...
                        checkExistingProduct.setInt(1, invoiceIdTable11);
                        ...
                        if (existingProductResult.next()) {
                            ...
                            updateInvoiceDetail.setInt(3, invoiceIdTable11);
                ...
                checkTrueBillDetailTable11 = true;
                saveBillTable11();
            }
        }
    }//GEN-LAST:event_AddBtnTable11MouseClicked

    private void AddBtnTable11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnTable11ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_AddBtnTable11ActionPerformed
    ...
    private void NameTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NameTable11MouseClicked

    }//GEN-LAST:event_NameTable11MouseClicked

    private void TIMESTART11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TIMESTART11ActionPerformed

    }//GEN-LAST:event_TIMESTART11ActionPerformed

    private void TIMEEND11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TIMEEND11ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TIMEEND11ActionPerformed

    private void StartBtnTable11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_StartBtnTable11MouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_StartBtnTable11MouseClicked

    private void StartBtnTable11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartBtnTable11ActionPerformed
        ...
        TIMESTART11.setText(formatStartTable1);
        NameTable11.setText("BÀN 11 (ĐANG CHƠI)");
        Name11.setText("BÀN 11 (ĐANG CHƠI)");
        NameTable11.setForeground(Color.RED);
        Name11.setForeground(Color.RED);

        StartBtnTable11.setEnabled(false);
        StopBtnTable11.setEnabled(true);

        Calendar cal = Calendar.getInstance();
        cal.setTime(currentStartTable1);

        startHourTable11 = cal.get(Calendar.HOUR_OF_DAY);
        startMinuteTable11 = cal.get(Calendar.MINUTE);
        startSecondTable11 = cal.get(Calendar.SECOND);

        AddBtnTable11.setEnabled(true);

        saveInputDataTable11();
    }//GEN-LAST:event_StartBtnTable11ActionPerformed

    private void StopBtnTable11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StopBtnTable11ActionPerformed
        ...
        TIMEEND11.setText(formatStopTable1);
        NameTable11.setText("BÀN 11 (ĐANG TÍNH TIỀN)");
        NameTable11.setForeground(Color.YELLOW);
        Name11.setText("BÀN 11 (ĐANG TÍNH TIỀN)");
        Name11.setForeground(Color.YELLOW);
        StopBtnTable11.setEnabled(false);
        PrintBtnTable11.setEnabled(true);

        Calendar cal = Calendar.getInstance();
        cal.setTime(currentStopTable1);

        endHourTable11 = cal.get(Calendar.HOUR_OF_DAY);
        endMinuteTable11 = cal.get(Calendar.MINUTE);
        endSecondTable11 = cal.get(Calendar.SECOND);

        //Luu gia tri sau khi set moi bien
        saveInputDataTable11();
    }//GEN-LAST:event_StopBtnTable11ActionPerformed

    private void PrintBtnTable11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PrintBtnTable11ActionPerformed
        Date currentPrintTable11 = new Date();
        SimpleDateFormat datePrintTable11 = new SimpleDateFormat("HH:mm:ss dd/MM/yyyy");
        String formatPrintTable11 = datePrintTable11.format(currentPrintTable11);
        String TableFee11 = CommonFunction.calculateTimePlayTablePrice55(startHourTable11, startMinuteTable11, startSecondTable11, endHourTable11, endMinuteTable11, endSecondTable11);
        Double totalFeeBill = Double.parseDouble(TableFee11) + TotalBill;
        String convertTotalFeeToString = CommonFunction.doubleFormattedView(totalFeeBill);
        System.out.println("totalfee: "+TableFee11 + " savePrice: " + TotalBill +" totalBill: "+ convertTotalFeeToString);
        try {
            ...
            addTableBill.setString(1, SDTKH11.getText());
            addTableBill.setString(2, formatPrintTable11);
            addTableBill.setString(3, TIMESTART11.getText());
            addTableBill.setString(4, TIMEEND11.getText());
            addTableBill.setString(5, TableFee11);
            addTableBill.setInt(6, 11);
            addTableBill.executeUpdate();

            if(soLanBamAddTable11 > 0) {
                ParameterReportCheckoutTable dataprint11 = new ParameterReportCheckoutTable(formatPrintTable11, TIMESTART11.getText(), TIMEEND11.getText(), TableFee11, invoiceIdTable11, convertTotalFeeToString);
                ReportManager55.getInstance().printReportPaymentTable(dataprint11);
            }
            else {
                ParameterReportCheckout dataprint11 = new ParameterReportCheckout(formatPrintTable11, TIMESTART11.getText(), TIMEEND11.getText(), TableFee11);
                ReportManager55.getInstance().printReportPayment(dataprint11);
            }

            PrintBtnTable11.setEnabled(false);
            NameTable11.setText("BÀN 11");
            NameTable11.setForeground(Color.BLACK);
            Name11.setText("BÀN 11");
            Name11.setForeground(Color.BLACK);
            StartBtnTable11.setEnabled(true);
            StopBtnTable11.setEnabled(false);
            TIMESTART11.setText("");
            TIMEEND11.setText("");
            SDTKH11.setText("");
            AddBtnTable11.setEnabled(false);
            saveInputDataTable11();
            System.out.println("Start time: " + startHourTable11 + ":" + startMinuteTable11 + ":" + startSecondTable11);
            System.out.println("End time: " + endHourTable11 + ":" + endMinuteTable11 + ":" + endSecondTable11);

            // Xu ly cho ca table va bill
            checkTrueBillDetailTable11 = false;
            PRODNAME.setText("");
            PRODQTY.setText("");
            BillReview.setText("");
    ...
    }//GEN-LAST:event_PrintBtnTable11ActionPerformed

    private void ResetBtnTable11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ResetBtnTable11ActionPerformed
    ...
    }//GEN-LAST:event_ResetBtnTable11ActionPerformed
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Table11AndCheckOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton AddBtnTable11;
    ...
    private javax.swing.JLabel NameTable11;
    ...
    private javax.swing.JButton PrintBtnTable11;
    private javax.swing.JButton ReloadBtn;
    private javax.swing.JButton ResetBtnTable11;
    private javax.swing.JTextField SDTKH11;
    private javax.swing.JButton StartBtnTable11;
    private javax.swing.JButton StopBtnTable11;
    private javax.swing.JPanel SwapNormalBtn;
    private javax.swing.JPanel SwapVipBtn;
    private javax.swing.JTextField TIMEEND11;
    private javax.swing.JTextField TIMESTART11;
